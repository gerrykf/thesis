...
-- 插入一级分类
INSERT INTO food_categories (name, name_en, level, sort_order, is_active) VALUES
('主食', 'Staple Food', 1, 1, TRUE),
('蔬菜', 'Vegetables', 1, 2, TRUE),
('水果', 'Fruits', 1, 3, TRUE),
('肉类', 'Meat', 1, 4, TRUE),
('海鲜', 'Seafood', 1, 5, TRUE),
('蛋类', 'Eggs', 1, 6, TRUE),
('奶制品', 'Dairy', 1, 7, TRUE),
('豆制品', 'Soy Products', 1, 8, TRUE),
('坚果', 'Nuts', 1, 9, TRUE),
('饮品', 'Beverages', 1, 10, TRUE);
...
CREATE TABLE IF NOT EXISTS foods (
    ...
    -- 营养成分(每100g)
    calories_per_100g DECIMAL(8,2) DEFAULT 0 COMMENT '每100g热量(kcal)',
...
CREATE TABLE IF NOT EXISTS diet_records (
    ...
    sodium DECIMAL(8,2) COMMENT '钠(mg)',
...
('admin', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/Ln8xqjEJ8KjDAKRBK', '系统管理员', 'admin', TRUE);
...
SELECT '管理员密码: admin123456' AS password;
